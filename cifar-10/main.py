# Download test.7z and train.7z from kaggle
# They are so much large to upload into github
import pandas as pd
import numpy as np
import os
...
y_train = to_categorical(convert_label(y_train), 10)
y_test = to_categorical(convert_label(y_test), 10)
